...
public class RetCode {
    ...
    public static final int UNKOWN_RET = 1;

    public static final int DEPLOY_GROUP_CONTRACT_FAILED = 30100;
    public static final int DEPLOY_RING_CONTRACT_FAILED = 30101;

    public static final int ETH_GROUP_SIG_VERIFY_FAILED = 30102;
    public static final int ETH_RING_SIG_VERIFY_FAILED = 30103;

    public static final int UPDATE_RING_SIG_DATA_FAILED = 30104;
    public static final int UPDATE_GROUP_SIG_DATA_FAILED = 30105;

    //    public final static int LOAD_CERT_FAILED = 30106;
    public static final int LOAD_CONTRACT_FAILED = 30107;

    public static final int CALL_GROUPSIG_RPC_FAILED = 30108;
    public static final int CALL_RINGSIG_RPC_FAILED = 30109;

    public static final int GET_CNS_CODE_FAILED = 30110;
    public static final int INVALID_CONTRACT_ADDRESS = 30110;

    public static final int CALL_RPC_FAILED = 30111;
    ...
    public static void Msg(int ret_code, String prefix) {
        ...
        if (LOAD_CONTRACT_FAILED == ret_code) System.out.println(prefix + "LOAD CONTRACT FAILED");

        if (CALL_GROUPSIG_RPC_FAILED == ret_code)
            System.out.println(
                    prefix + "CALL GROUPSIG RPC BEFORE DEPLOY GROUP SIG CONTRACT FAILED");
